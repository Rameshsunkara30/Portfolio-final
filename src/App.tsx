        ...
        <div className="container mx-auto px-6 py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                {[
                  { icon: MapPin, text: "MVP Colony, Vishakapatnam", link: "https://www.google.co.in/maps/@17.7429478,83.3332452,16.1z?entry=ttu&g_ep=EgoyMDI1MTAxNC4wIKXMDSoASAFQAw%3D%3D" },
